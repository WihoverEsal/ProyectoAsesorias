...
public class ProyectoEntrada {
    ...
    public void setHora(String cad1) {
        hora.set(cad1);
    }
    ...
    public void setLunes(String cad2) {
        lunes.set(cad2);
    }
    ...
    public void setMartes(String cad3) {
        martes.set(cad3);
    }
    ...
    public void setMiercoles(String cad4) {
        miercoles.set(cad4);
    }
    ...
    public void setJueves(String cad5) {
        jueves.set(cad5);
    }
    ...
    public void setViernes(String cad6) {
        viernes.set(cad6);
    }
}
